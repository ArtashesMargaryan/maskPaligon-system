...
const getRetryBtnIdleTweenConfig = (): TweenConfig => {
    return {
        universal: true,
        pixi: { scale: 1.06 },
        duration: 0.6,
...
export class LoseView extends ResultViewAbstract {
    ...
    private _show(): void {
        PIXI.tween
            ...
            .add([PIXI.tween.to(this._retryBtn, getRetryBtnIdleTweenConfig())]);
    }
    ...
    private _buildBlocker(): PIXI.Graphics {
        return new BlockerComponent(0x0, 0.4);
    }
